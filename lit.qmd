...
这里“书籍”包含一切有章节划分的读物。
对于章节相对独立书籍，建议以章为单位记录笔记，将每一章作为一篇文章看待。
笔记方法参见“文章笔记”。
对于连结性比较强的章节，可将各章节放在同一个笔记中，但笔记内容还是建议贯彻格式化
...
[Obsidian](https://obsidian.md)是一款多窗口支持，高效笔记软件。
虽然不是必须，但通过`Citations` 插件能够实现和Zotero的紧密联动。
之后通过Obsidian强大的搜索和双链功能，能够很好地将关联文献连接起来，最终形成文献综述。
具体的使用方法，请参见以下这个视频：

<iframe src="//player.bilibili.com/player.html?aid=763217753&bvid=BV1E64y187er&cid=413748386&page=1&autoplay=0" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
